        ...
        <>
            <nav className="navbar fixed-top navbar-expand-lg bg-light ">
                <div className="container-fluid ms-4 me-4 navcon">
                    <a className="navbar-brand" href="..."><img src={require('../assests/whole.png')} alt="..."></img></a>
                    ...
                    <div className="text">
                        ...
                        <p>Create account <a href="..."data-bs-toggle="modal" data-bs-target="#Login">It's Free </a><img src={require("../assests/Vector (1).png")}  alt="..."></img></p>
                    </div>
                </div>
            </nav>
        </>
